...
aplicada por tela.`,
  ...
  'admin.content_expiry.title': "Validade dos arquivos",
  'admin.content_expiry.desc': "Depois da data o arquivo sai de todas as playlists e para de ser exibido. Vale para o workspace aberto no seletor acima. Deixe em branco para não expirar.",
  'admin.content_expiry.filter': "Filtrar por nome…",
  'admin.content_expiry.empty': "Nenhum arquivo neste workspace.",
  'admin.content_expiry.col_file': "Arquivo",
  'admin.content_expiry.col_expiry': "Validade",
  'admin.content_expiry.blocked': "bloqueado",
  'admin.content_expiry.clear': "Liberar",
  'admin.content_expiry.saved': "Validade atualizada",
  'admin.content_expiry.more': "e mais {n} — use o filtro",
