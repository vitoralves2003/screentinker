...
export default {
  ...
  'exhibition.title': 'Exhibitions',
  'exhibition.times_in': 'Times in {tz}',
  'exhibition.range.today': 'Today',
  'exhibition.range.7d': '7 days',
  'exhibition.range.30d': '30 days',
  'exhibition.apply': 'Apply',
  'exhibition.live': 'Live',
  'exhibition.export': 'Export CSV',
  'exhibition.col.time': 'Time',
  'exhibition.col.file': 'File',
  'exhibition.col.list': 'List',
  'exhibition.col.duration': 'Duration',
  'exhibition.total.plays': 'Exhibitions',
  'exhibition.total.time': 'Time on air',
  'exhibition.total.files': 'Distinct files',
  'exhibition.total.lists': 'Lists',
  'exhibition.list_unknown': 'list not recorded',
  'exhibition.list_unknown_tip': 'This play predates the release that started recording which list content came from. It is not guessed.',
  'exhibition.list_deleted': 'deleted',
  'exhibition.list_deleted_tip': 'The list has been deleted; the name is the one it had when this played.',
  'exhibition.empty': 'Nothing in this period',
  'exhibition.empty_hint': 'History is kept for {days} days. An older period returns empty even if the screen was playing.',
  'exhibition.truncated': 'showing the {n} most recent — export for the whole period',
  'exhibition.unattributed': '{n} without a recorded list',
  'exhibition.tz_assumed': 'this screen has never reported a timezone; times shown in UTC',
  'exhibition.failed': 'Could not load the exhibitions',
