...
export default {
  ...
  'report.retention_note': "Plays and airtime cover the last {days} days — older history is discarded. The \"In playlists\", \"On screens\" and \"Screens\" columns describe how things stand today and do not depend on that window.",
  ...
  'filereport.back': 'Back to files',
  'filereport.where_title': 'Where this file is',
  'filereport.where_sub': 'The current setup. True now, and it does not depend on play history.',
  'filereport.plays_title': 'What it has played',
  'filereport.plays_sub': 'From {start} to {end}. History is kept for {days} days.',
  'filereport.tile.lists': 'Lists',
  'filereport.tile.screens': 'Screens',
  'filereport.tile.plays': 'Exhibitions',
  'filereport.tile.days': 'Days on air',
  'filereport.tile.time': 'Time on air',
  'filereport.in_lists': 'In these lists',
  'filereport.in_no_list': 'This file is not in any list, so no screen is showing it.',
  'filereport.on_screens': 'On these screens',
  'filereport.on_no_screen': 'No screen runs a list containing this file.',
  'filereport.via_sublist': 'through {list}',
  'filereport.via_zone': 'in a zone',
  'filereport.by_screen': 'By screen',
  'filereport.by_list': 'By list',
  'filereport.col.screen': 'Screen',
  'filereport.col.list': 'List',
  'filereport.col.plays': 'Exhibitions',
  'filereport.col.time': 'Time',
  'filereport.list_unknown': 'list not recorded',
  'filereport.list_unknown_tip': 'These plays predate the release that started recording which list content came from. They are not guessed.',
  'filereport.list_deleted': 'deleted',
  'filereport.no_plays': 'No exhibitions in this period',
  'filereport.no_plays_hint': 'History is kept for {days} days. An older period returns empty even if the file was playing.',
  'filereport.chart_label': 'Exhibitions per day',
  'filereport.per_day': 'per day',
  'filereport.failed': 'Could not load this file',
  'filereport.open': 'Report',
...
per display.`,
  ...
  'settings.hide_branding': 'Hide "Loop Player" branding',
  ...
  'report.tile.airtime': 'Time on air',
