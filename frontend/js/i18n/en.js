...
export default {
  ...
  'ops.bill.uninvoiced_title': "{month} invoice — {amount}",
  'ops.bill.uninvoiced_body': "The charge has not been sent yet. Nothing is overdue — you will be notified as soon as it is available.",
  'ops.bill.due_title': "{month} invoice — {amount}",
  'ops.bill.due_body': "Due {date}.",
  'ops.bill.overdue_title': "{month} invoice is overdue — {amount}",
  'ops.bill.overdue_body': "It was due {date}, {days} ago.",
  'ops.bill.suspended_title': "Panel blocked over an overdue invoice",
  'ops.bill.suspended_body': "Your screens keep showing the content already published. Settle the payment to start editing again.",
  'ops.bill.cut_title': "Access withheld over an overdue invoice",
  'ops.bill.cut_body': "{month} invoice, {amount}. Settle the payment to restore service.",
  'ops.bill.pay': "View invoice",
  'ops.bill.days_one': "{n} day",
  'ops.bill.days_other': "{n} days",
  'ops.bill.suspend_in_one': "The panel will be blocked in {n} day.",
  'ops.bill.suspend_in_other': "The panel will be blocked in {n} days.",
  'ops.bill.suspend_imminent': "The panel may be blocked at any moment.",
  'ops.bill.cut_in_one': "Access will be withheld in {n} day.",
  'ops.bill.cut_in_other': "Access will be withheld in {n} days.",
  'ops.bill.more_one': "{n} further invoice open — {total} in total.",
  'ops.bill.more_other': "{n} further invoices open — {total} in total.",
  'ops.attention': "Need attention",
  'ops.attention_offline': "offline during opening hours",
  'ops.attention_no_list': "no playlist — showing nothing",
  'ops.attention_zone_no_list': "zone with no playlist: {zones}",
  ...
  'dashboard.filtro.mostrando_one': "Showing 1 screen — {rotulo}",
  'dashboard.filtro.mostrando_other': "Showing {n} screens — {rotulo}",
  'dashboard.filtro.ver_todas': "Show all",
  'dashboard.filtro.atencao': "needs attention",
  'dashboard.filtro.fora_do_ar': "offline",
  'dashboard.filtro.no_ar': "online",
  'dashboard.filtro.tela': "this screen",
  'dashboard.filtro.vazio': "No screen matches this filter",
  'dashboard.filtro.vazio_desc': "The fleet may have changed since this link was made.",
  ...
  'dashboard.col_lists': "Lists",
  'dashboard.layout_fullscreen': "Full screen",
  'dashboard.no_list': "Choose a playlist",
  'dashboard.no_list_tip': "This screen will show nothing until it is given a playlist.",
  'dashboard.zone_no_list_tip': "This zone has no playlist and stays blank on the screen.",
  'dashboard.n_lists': "{n} playlists",
...
per display.`,
  ...
  'admin.integr.asaas_desc': "The API key that issues charges. Stored encrypted; never shown back.",
  'admin.integr.email': "E-mail",
  'admin.integr.email_desc': "The server that sends invoices, invitations and password resets.",
  'admin.integr.api_key': "API key",
  'admin.integr.webhook_token': "Webhook token",
  'admin.integr.webhook_url': "Webhook URL (paste into the Asaas panel)",
  'admin.integr.mode': "Environment",
  'admin.integr.sandbox': "Sandbox (test)",
  'admin.integr.production': "Production (charges for real)",
  'admin.integr.not_set': "not configured",
  'admin.integr.unreadable': "unreadable — enter it again",
  'admin.integr.stored': "stored {hint}",
  'admin.integr.leave_blank': "leave blank to keep the current one",
  'admin.integr.test': "Test",
  'admin.integr.testing': "checking…",
  'admin.integr.clear_key': "Delete key",
  'admin.integr.clear_confirm': "Delete the Asaas key? No charge will be issued until another is set.",
  'admin.integr.cleared': "Key deleted",
  'admin.integr.saved': "Saved",
  'admin.integr.asaas_ok': "account: {name} · {doc} · {mode}",
  'admin.integr.host': "Host",
  'admin.integr.port': "Port",
  'admin.integr.user': "User",
  'admin.integr.password': "Password",
  'admin.integr.from': "From",
  'admin.integr.secure': "Direct TLS (port 465). Unchecked uses STARTTLS (587).",
  'admin.integr.send_test': "Send test",
  'admin.integr.sending': "sending…",
  'admin.integr.sent_to': "sent to {to}",
  'admin.integr.jwt_warning': "These secrets are encrypted with a key derived from the server JWT_SECRET. If it is rotated they must all be entered again — here, and in 2FA and SSO.",
  'admin.integr.spf_warning': "Configuring the server is the easy part. What decides whether the invoice arrives is SPF, DKIM and DMARC on the domain: without them, billing mail from your own server lands in spam often.",
  ...
  'admin.people.title': "People and access",
  'admin.people.desc': "Who can sign in. Customers and who belongs to each are on the Clientes tab — this is passwords, platform permissions and accounts with no customer.",
  ...
  'admin.tenants.title': "Customers",
  'admin.tenants.desc': "Each customer, what they are on and what is outstanding. Click to open.",
  'admin.tenants.search': "Search by name, legal name, tax id or e-mail",
  'admin.tenants.col_name': "Customer",
  'admin.tenants.col_plan': "Plan",
  'admin.tenants.col_screens': "Screens",
  'admin.tenants.col_state': "Status",
  'admin.tenants.col_owed': "Outstanding",
  'admin.tenants.state_ok': "Up to date",
  'admin.tenants.state_due': "Not yet due",
  'admin.tenants.state_overdue': "Overdue",
  'admin.tenants.state_not_invoiced': "Never charged",
  'admin.tenants.state_suspended': "Panel blocked",
  'admin.tenants.state_cut': "Access withheld",
  'admin.tenants.none': "No customers found.",
  'admin.tenants.n_members': "{n} people",
  'admin.tenants.members': "Who has access ({n})",
  'admin.tenants.no_members': "Nobody has access.",
  'admin.tenants.no_company': "Company details not filled in",
  'admin.tenants.since': "Customer since",
  'admin.tenants.asaas': "Asaas record",
  'admin.tenants.asaas_yes': "Created",
  'admin.tenants.asaas_no': "Not created yet",
  'admin.tenants.delete_body': "This erases <b>{name}</b> entirely: screens, files, playlists and billing history. Type the customer name to confirm.",
  'admin.tenants.deleted': "{name} has been deleted.",
  'admin.tenants.plan_changed': "{name} is now on the {plan} plan.",
  'admin.tenants.delete': "Delete customer",
  'admin.tenants.delete_hint': "Deletes screens, files, playlists and billing history. No way back.",
  'admin.tenants.dormant_title': "Signups with no screen",
  'admin.tenants.dormant_desc': "Registered, never added a screen and never had an invoice. Not customers yet.",
  'admin.tab.billing': "Billing",
  'admin.cash.paying': "Paying customers",
  'admin.cash.of_total_internal': "of {n} accounts · {i} in-house",
  'admin.cash.of_total': "of {n} in total",
  'admin.cash.received': "Received this month",
  'admin.cash.in_month': "{month} — {n} invoice(s)",
  'admin.cash.accruing': "Accruing now",
  'admin.cash.accruing_hint': "Current month projection, by licence-days.",
  'admin.cash.billed_prev': "Billed last month",
  'admin.cash.open_title': "Outstanding — {total}",
  'admin.cash.overdue': "Overdue",
  'admin.cash.invoices': "{n} invoice(s)",
  'admin.cash.not_invoiced': "Never charged",
  'admin.cash.not_invoiced_hint': "{n} invoice(s) — the customer was never asked",
  'admin.cash.not_due': "Not yet due",
  'admin.cash.suspended': "Panel blocked",
  'admin.cash.suspended_hint': "Screens keep playing.",
  'admin.cash.cut': "Access withheld",
  'admin.cash.cut_hint': "Screens disconnected.",
  'admin.cash.missing_nfse': "{n} paid month(s) with no nota fiscal — {total}",
  'admin.cash.missing_nfse_hint': "Money received with no document issued. See Integrations → Nota fiscal.",
  'admin.nfse.title': "Nota fiscal (NFS-e)",
  'admin.nfse.desc': "Issued automatically once an invoice is paid. These numbers come from your accountant and your city — the digital certificate and municipal registration live in your Asaas account.",
  'admin.nfse.enabled': "Issue a nota fiscal automatically after payment",
  'admin.nfse.service_code': "Municipal service code",
  'admin.nfse.service_code_hint': "The item on your city's list matching what you sell.",
  'admin.nfse.service_name': "Service description (city)",
  'admin.nfse.description': "Description printed on the document",
  'admin.nfse.description_hint': "{month} is replaced by the period; {screens} by the average screen count.",
  'admin.nfse.taxes': "Tax rates",
  'admin.nfse.taxes_hint': "As percentages. Zero is a valid answer — under Simples Nacional most of these are zero.",
  'admin.nfse.deductions': "Deductions",
  'admin.nfse.retain_iss': "ISS withheld by the payer",
  'admin.nfse.not_ready': "Not issuing yet: {missing} still missing.",
  'admin.nfse.pending': "{n} paid month(s) with no document issued",
  'admin.nfse.all_issued': "Every paid month has a document.",
  'admin.nfse.issue': "Issue",
  'admin.nfse.issued': "Document requested.",
  'billing.col_nfse': "Nota fiscal",
  'billing.nfse_view': "View",
  'billing.company': "Company details",
  'billing.company_help': "Used to issue the nota fiscal. Fill this in if you need one; billing works normally without it.",
  'billing.trade_name': "Trading name",
  'billing.trade_name_hint': "What your business is known as. It becomes your account name in Loop Player. Left blank, we use the legal name.",
  'billing.saved_renamed': "Saved. Your account is now called \"{name}\".",
  'billing.legal_name': "Legal name",
  'billing.legal_name_hint': "The name that appears on the nota fiscal. Left blank, we use \"{name}\".",
  'billing.municipal_inscription': "Municipal registration",
  'billing.phone': "Phone",
  'billing.postal_code': "Postcode",
  'billing.address': "Street",
  'billing.address_number': "Number",
  'billing.complement': "Complement",
  'billing.province': "District",
  'billing.saved': "Saved.",
  'billing.saved_not_synced': "Saved here, but it did not reach the issuer: {error}",
