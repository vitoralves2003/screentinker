...
export default {
  ...
  'dashboard.btn_open': 'Open screen',
  'dashboard.btn_delete': 'Remove screen',
  'dashboard.confirm_delete_device': 'Remove "{name}"?\n\nThe panel stays paired to nothing and keeps playing its cached list until someone unplugs it.',
  'dashboard.toast.device_deleted': 'Screen removed',
