...
per display.`,
  ...
  'admin.content_expiry.title': "File expiry",
  'admin.content_expiry.desc': "After this instant the file leaves every playlist and stops playing. Applies to the workspace open in the switcher above. Leave blank for no expiry.",
  'admin.content_expiry.filter': "Filter by name…",
  'admin.content_expiry.empty': "No files in this workspace.",
  'admin.content_expiry.col_file': "File",
  'admin.content_expiry.col_expiry': "Expiry",
  'admin.content_expiry.blocked': "blocked",
  'admin.content_expiry.clear': "Release",
  'admin.content_expiry.saved': "Expiry updated",
  'admin.content_expiry.more': "and {n} more — use the filter",
