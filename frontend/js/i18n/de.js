...
export default {
  ...
  'admin.content_expiry.title': "Ablauf der Dateien",
  'admin.content_expiry.desc': "Nach diesem Zeitpunkt verlässt die Datei jede Playlist und wird nicht mehr abgespielt. Gilt für den im Umschalter geöffneten Workspace. Leer lassen für keinen Ablauf.",
  'admin.content_expiry.filter': "Nach Name filtern…",
  'admin.content_expiry.empty': "Keine Dateien in diesem Workspace.",
  'admin.content_expiry.col_file': "Datei",
  'admin.content_expiry.col_expiry': "Ablauf",
  'admin.content_expiry.blocked': "gesperrt",
  'admin.content_expiry.clear': "Freigeben",
  'admin.content_expiry.saved': "Ablauf aktualisiert",
  'admin.content_expiry.more': "und {n} weitere — Filter benutzen",
