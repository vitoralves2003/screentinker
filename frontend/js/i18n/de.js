...
export default {
  ...
  'dashboard.filtro.mostrando_one': "1 Bildschirm angezeigt — {rotulo}",
  'dashboard.filtro.mostrando_other': "{n} Bildschirme angezeigt — {rotulo}",
  'dashboard.filtro.ver_todas': "Alle anzeigen",
  'dashboard.filtro.atencao': "brauchen Aufmerksamkeit",
  'dashboard.filtro.fora_do_ar': "offline",
  'dashboard.filtro.no_ar': "online",
  'dashboard.filtro.tela': "dieser Bildschirm",
  'dashboard.filtro.vazio': "Kein Bildschirm entspricht diesem Filter",
  'dashboard.filtro.vazio_desc': "Der Bestand kann sich seit Erstellung dieses Links geändert haben.",
