...
export default {
  ...
  'settings.hide_branding': 'Masquer la marque « Loop Player »',
  ...
  'admin.content_expiry.title': "Expiration des fichiers",
  'admin.content_expiry.desc': "Passé cet instant le fichier quitte toutes les listes et cesse d’être diffusé. Vaut pour l’espace ouvert dans le sélecteur. Laissez vide pour ne pas expirer.",
  'admin.content_expiry.filter': "Filtrer par nom…",
  'admin.content_expiry.empty': "Aucun fichier dans cet espace.",
  'admin.content_expiry.col_file': "Fichier",
  'admin.content_expiry.col_expiry': "Expiration",
  'admin.content_expiry.blocked': "bloqué",
  'admin.content_expiry.clear': "Libérer",
  'admin.content_expiry.saved': "Expiration mise à jour",
  'admin.content_expiry.more': "et {n} de plus — utilisez le filtre",
