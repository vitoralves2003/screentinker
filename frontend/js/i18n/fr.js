...
export default {
  ...
  'dashboard.filtro.mostrando_one': "1 écran affiché — {rotulo}",
  'dashboard.filtro.mostrando_other': "{n} écrans affichés — {rotulo}",
  'dashboard.filtro.ver_todas': "Tout afficher",
  'dashboard.filtro.atencao': "nécessitent une attention",
  'dashboard.filtro.fora_do_ar': "hors ligne",
  'dashboard.filtro.no_ar': "en ligne",
  'dashboard.filtro.tela': "cet écran",
  'dashboard.filtro.vazio': "Aucun écran ne correspond à ce filtre",
  'dashboard.filtro.vazio_desc': "Le parc a pu changer depuis la création de ce lien.",
  'dashboard.no_displays': 'Aucun écran pour le moment',
  'dashboard.no_displays_desc': 'Installez l\'application Loop Player sur votre TV et appariez-la avec le bouton ci-dessus.',
  ...
  'content.schedule_hint': "Choisissez un type pour ajouter une règle. Les règles de même type sont des alternatives ; celles de types différents doivent toutes être vérifiées. Vaut pour toutes les listes contenant ce fichier. Sans règle, il est toujours diffusé.",
  ...
  'content.title': "Fichiers",
  'content.subtitle': "Importez et organisez vos médias",
  ...
  'content.search_placeholder': "Rechercher des fichiers...",
  'content.new_folder_btn': '+ Nouveau dossier',
  'content.breadcrumb_root': "Tous les fichiers",
  ...
  'content.no_content': "Aucun fichier pour le moment",
  ...
  'device.zone.title': "Quelle liste est diffusée dans chaque zone",
  'device.zone.none': "— aucune —",
  'device.zone.save': "Enregistrer les zones",
  'device.zone.saved': "Zones enregistrées",
  'replace_display.title': "Remplacer l'appareil",
  'replace_display.intro': "Saisissez le code d'appairage affiché par le nouvel appareil pour « {name} ».",
  'replace_display.keeps': "L'écran conserve son nom, sa liste, sa mise en page, son son et son historique. L'appareil actuel redemande un code.",
  'replace_display.confirm': "Remplacer",
  'device.replace': "Remplacer l'appareil",
  'device.replace.prompt': "Saisissez le code d'appairage affiché par le nouvel appareil.\n\n« {name} » conserve son nom, sa liste, sa mise en page, son son et son historique. L'appareil actuel redemande un code.",
  'device.replace.bad_code': "Le code comporte 6 chiffres",
  'device.replace.done': "« {name} » fonctionne maintenant sur le nouvel appareil",
  ...
  'device.form.unsaved': "modifications non enregistrées",
  ...
  'settings.setup_step_1': 'Installez l\'APK Loop Player sur votre TV via le sideloading',
  ...
  'settings.import.invalid_file': 'Fichier invalide. Doit être un JSON ou ZIP d\'export Loop Player.',
  ...
  'playlist.duplicate_playlist': "Dupliquer la liste",
  'playlist.toast.duplicated': "Copiée sous « {name} » — c’est un brouillon, publiez-la pour l’envoyer aux écrans",
  'playlist.bulk_duplicate_one': "Dupliquer 1",
  'playlist.bulk_duplicate_other': "Dupliquer {n}",
  'playlist.bulk_duplicated_one': "1 liste dupliquée — la copie est un brouillon",
  'playlist.bulk_duplicated_other': "{n} listes dupliquées — les copies sont des brouillons",
  ...
  'playlist.sub_order_sequence': "Dans l’ordre",
  'playlist.sub_order_random': "Aléatoire",
  'playlist.sub_order_hint': "Dans l’ordre lit la liste de haut en bas. Aléatoire la mélange, sans répéter un élément avant que tous soient passés.",
  'playlist.toast.sub_order_saved': "Ordre modifié — publiez la liste pour l’envoyer aux écrans",
  ...
  'content.toast.added_to_list_skipped': "{added} ajouté(s) à « {name} », {skipped} déjà présent(s) — publiez pour l’envoyer aux écrans",
  'content.sched_state.active': "À l antenne — dans sa plage horaire",
  'content.sched_state.pending': "Programmé — hors plage pour le moment",
  'content.sched_state.expired': "Programmation terminée — ne sera plus diffusé",
  'itemsched.type.datetime_range': "Période de jours et heures",
  'itemsched.type.time_range': "Heures de la journée",
  'itemsched.type.weekday_time': "Heures de la journée un jour précis",
  'itemsched.type.weekday': "Jour de la semaine",
  'itemsched.type.day_of_month': "Jour du mois",
  'itemsched.type.month': "Mois",
  'itemsched.dow_long': "Dimanche,Lundi,Mardi,Mercredi,Jeudi,Vendredi,Samedi",
  'itemsched.months': "Janvier,Février,Mars,Avril,Mai,Juin,Juillet,Août,Septembre,Octobre,Novembre,Décembre",
  'itemsched.or': "ou",
  'itemsched.and': "et",
  'itemsched.desc.always': "Aucune programmation — ce fichier est toujours diffusé.",
  'itemsched.desc.sentence': "Diffusé {clauses}.",
  'itemsched.desc.weekday': "le {days}",
  'itemsched.desc.weekday_time': "le {parts}",
  'itemsched.desc.time_range': "de {parts}",
  'itemsched.desc.day_of_month': "le {days} du mois",
  'itemsched.desc.month': "en {months}",
  'itemsched.desc.datetime_range': "pendant {parts}",
  'itemsched.err.range_incomplete': "Renseignez les deux bornes de la période",
  'itemsched.err.range_order': "La fin de la période doit suivre le début",
  'itemsched.err.empty_window': "Le début et la fin de la plage horaire ne peuvent pas être identiques",
  'device.audio.title': 'Son',
  'device.audio.label': 'Cet écran peut diffuser du son',
  'device.audio.hint': 'Désactivé, tout est lu en silence sur cet écran, même si la vidéo a du son. Le volume reste réglé par la télécommande.',
  'device.audio.on': 'Son autorisé sur cet écran',
  'device.audio.off': 'Cet écran est désormais silencieux',
  ...
  'onboarding.step.welcome.title': 'Bienvenue sur Loop Player !',
