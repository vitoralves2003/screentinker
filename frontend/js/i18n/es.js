...
export default {
  ...
  'settings.hide_branding': 'Ocultar la marca "Loop Player"',
  ...
  'admin.content_expiry.title': "Vigencia de los archivos",
  'admin.content_expiry.desc': "Después de esa fecha el archivo sale de todas las listas y deja de reproducirse. Se aplica al espacio abierto en el selector. Déjelo vacío para no expirar.",
  'admin.content_expiry.filter': "Filtrar por nombre…",
  'admin.content_expiry.empty': "Sin archivos en este espacio.",
  'admin.content_expiry.col_file': "Archivo",
  'admin.content_expiry.col_expiry': "Vigencia",
  'admin.content_expiry.blocked': "bloqueado",
  'admin.content_expiry.clear': "Liberar",
  'admin.content_expiry.saved': "Vigencia actualizada",
  'admin.content_expiry.more': "y {n} más — use el filtro",
