...
export default {
  ...
  'dashboard.filtro.mostrando_one': "Mostrando 1 pantalla — {rotulo}",
  'dashboard.filtro.mostrando_other': "Mostrando {n} pantallas — {rotulo}",
  'dashboard.filtro.ver_todas': "Ver todas",
  'dashboard.filtro.atencao': "necesitan atención",
  'dashboard.filtro.fora_do_ar': "fuera de línea",
  'dashboard.filtro.no_ar': "en línea",
  'dashboard.filtro.tela': "esta pantalla",
  'dashboard.filtro.vazio': "Ninguna pantalla coincide con este filtro",
  'dashboard.filtro.vazio_desc': "La flota puede haber cambiado desde que se creó este enlace.",
  'dashboard.no_displays': 'Aún no hay pantallas',
  'dashboard.no_displays_desc': 'Instala la aplicación de Loop Player en tu TV y vincúlala con el botón de arriba.',
  ...
  'content.schedule_hint': "Elija un tipo para agregar una regla. Las reglas del mismo tipo son alternativas; las de tipos distintos deben cumplirse todas. Se aplica a todas las listas que contienen este archivo. Sin reglas, siempre se reproduce.",
  ...
  'content.title': "Archivos",
  'content.subtitle': "Sube y organiza tus medios",
  ...
  'content.search_placeholder': "Buscar archivos...",
  ...
  'content.breadcrumb_root': "Todos los archivos",
  ...
  'content.no_content': "Aún no hay archivos",
  ...
  'device.zone.title': "Qué lista se reproduce en cada zona",
  'device.zone.none': "— ninguna —",
  'device.zone.save': "Guardar zonas",
  'device.zone.saved': "Zonas guardadas",
  'replace_display.title': "Sustituir pantalla",
  'replace_display.intro': "Introduce el código de emparejamiento que muestra el nuevo dispositivo para \"{name}\".",
  'replace_display.keeps': "La pantalla conserva nombre, lista, diseño, sonido e historial. El dispositivo actual vuelve a pedir un código.",
  'replace_display.confirm': "Sustituir",
  'device.replace': "Sustituir pantalla",
  'device.replace.prompt': "Introduce el código de emparejamiento que muestra el nuevo dispositivo.\n\n\"{name}\" conserva nombre, lista, diseño, sonido e historial. El dispositivo actual vuelve a pedir un código.",
  'device.replace.bad_code': "El código tiene 6 dígitos",
  'device.replace.done': "\"{name}\" ahora funciona en el nuevo dispositivo",
  ...
  'device.form.unsaved': "cambios sin guardar",
  ...
  'settings.setup_step_1': 'Instala el APK de Loop Player en tu TV mediante sideloading',
  ...
  'settings.import.invalid_file': 'Archivo no válido. Debe ser un JSON o ZIP de exportación de Loop Player.',
  ...
  'playlist.duplicate_playlist': "Duplicar lista",
  'playlist.toast.duplicated': "Copiada como \"{name}\" — es un borrador, publíquela para enviarla a las pantallas",
  'playlist.bulk_duplicate_one': "Duplicar 1",
  'playlist.bulk_duplicate_other': "Duplicar {n}",
  'playlist.bulk_duplicated_one': "1 lista duplicada — la copia es un borrador",
  'playlist.bulk_duplicated_other': "{n} listas duplicadas — las copias son borradores",
  'playlist.back': 'Atrás',
  ...
  'playlist.sub_order_sequence': "En secuencia",
  'playlist.sub_order_random': "Aleatorio",
  'playlist.sub_order_hint': "En secuencia reproduce en el orden de la lista. Aleatorio la mezcla, sin repetir un elemento antes de pasar por todos.",
  'playlist.toast.sub_order_saved': "Orden cambiado — publique la lista para enviarla a las pantallas",
  ...
  'content.btn_preview': "Vista previa",
  ...
  'content.toast.added_to_list_skipped': "{added} agregado(s) a \"{name}\", {skipped} ya estaba(n) — publique para enviarla a las pantallas",
  'content.sched_state.active': "Al aire ahora — dentro de su programación",
  'content.sched_state.pending': "Programado — fuera de horario en este momento",
  'content.sched_state.expired': "Programación terminada — ya no se reproduce",
  'itemsched.type.datetime_range': "Período de días y horas",
  'itemsched.type.time_range': "Horas del día",
  'itemsched.type.weekday_time': "Horas del día en un día específico",
  'itemsched.type.weekday': "Día de la semana",
  'itemsched.type.day_of_month': "Día del mes",
  'itemsched.type.month': "Mes",
  'itemsched.dow_long': "Domingo,Lunes,Martes,Miércoles,Jueves,Viernes,Sábado",
  'itemsched.months': "Enero,Febrero,Marzo,Abril,Mayo,Junio,Julio,Agosto,Septiembre,Octubre,Noviembre,Diciembre",
  'itemsched.or': "o",
  'itemsched.and': "y",
  'itemsched.desc.always': "Sin programación — este archivo siempre se reproduce.",
  'itemsched.desc.sentence': "Se reproduce {clauses}.",
  'itemsched.desc.weekday': "los {days}",
  'itemsched.desc.weekday_time': "en {parts}",
  'itemsched.desc.time_range': "de {parts}",
  'itemsched.desc.day_of_month': "el día {days} del mes",
  'itemsched.desc.month': "en {months}",
  'itemsched.desc.datetime_range': "durante {parts}",
  'itemsched.err.range_incomplete': "Complete las dos fechas del período",
  'itemsched.err.range_order': "El fin del período debe ser posterior al inicio",
  'itemsched.err.empty_window': "El inicio y el fin del horario no pueden ser iguales",
  'device.audio.title': 'Sonido',
  'device.audio.label': 'Esta pantalla puede reproducir sonido',
  'device.audio.hint': 'Apagado, todo se reproduce en silencio en esta pantalla, aunque el vídeo tenga audio. El volumen sigue siendo del mando del televisor.',
  'device.audio.on': 'Sonido permitido en esta pantalla',
  'device.audio.off': 'Esta pantalla queda en silencio',
  ...
  'onboarding.step.welcome.title': '¡Bienvenido a Loop Player!',
