...
export default {
  ...
  'admin.content_expiry.title': "Scadenza dei file",
  'admin.content_expiry.desc': "Dopo questo istante il file esce da ogni lista e smette di essere riprodotto. Vale per lo spazio aperto nel selettore. Lascia vuoto per non scadere.",
  'admin.content_expiry.filter': "Filtra per nome…",
  'admin.content_expiry.empty': "Nessun file in questo spazio.",
  'admin.content_expiry.col_file': "File",
  'admin.content_expiry.col_expiry': "Scadenza",
  'admin.content_expiry.blocked': "bloccato",
  'admin.content_expiry.clear': "Sblocca",
  'admin.content_expiry.saved': "Scadenza aggiornata",
  'admin.content_expiry.more': "e altri {n} — usa il filtro",
  ...
  'settings.hide_branding': 'Nascondi marchio "Loop Player"',
