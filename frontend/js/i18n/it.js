...
export default {
  ...
  'content.toast.added_to_list_skipped': "{added} aggiunti a \"{name}\", {skipped} già presenti — pubblica per inviarla agli schermi",
  'content.sched_state.active': "In onda ora — dentro la programmazione",
  'content.sched_state.pending': "Programmato — fuori orario in questo momento",
  'content.sched_state.expired': "Programmazione conclusa — non andrà più in onda",
  'itemsched.type.datetime_range': "Periodo di giorni e ore",
  'itemsched.type.time_range': "Ore del giorno",
  'itemsched.type.weekday_time': "Ore del giorno in un giorno specifico",
  'itemsched.type.weekday': "Giorno della settimana",
  'itemsched.type.day_of_month': "Giorno del mese",
  'itemsched.type.month': "Mese",
  'itemsched.dow_long': "Domenica,Lunedì,Martedì,Mercoledì,Giovedì,Venerdì,Sabato",
  'itemsched.months': "Gennaio,Febbraio,Marzo,Aprile,Maggio,Giugno,Luglio,Agosto,Settembre,Ottobre,Novembre,Dicembre",
  'itemsched.or': "o",
  'itemsched.and': "e",
  'itemsched.desc.always': "Nessuna programmazione — questo file viene sempre riprodotto.",
  'itemsched.desc.sentence': "Riproduce {clauses}.",
  'itemsched.desc.weekday': "di {days}",
  'itemsched.desc.weekday_time': "di {parts}",
  'itemsched.desc.time_range': "dalle {parts}",
  'itemsched.desc.day_of_month': "il {days} del mese",
  'itemsched.desc.month': "a {months}",
  'itemsched.desc.datetime_range': "nel periodo {parts}",
  'itemsched.err.range_incomplete': "Compila entrambe le date del periodo",
  'itemsched.err.range_order': "La fine del periodo deve essere successiva all inizio",
  'itemsched.err.empty_window': "Inizio e fine della fascia oraria non possono coincidere",
  ...
  'dashboard.filtro.mostrando_one': "1 schermo mostrato — {rotulo}",
  'dashboard.filtro.mostrando_other': "{n} schermi mostrati — {rotulo}",
  'dashboard.filtro.ver_todas': "Mostra tutti",
  'dashboard.filtro.atencao': "richiedono attenzione",
  'dashboard.filtro.fora_do_ar': "offline",
  'dashboard.filtro.no_ar': "online",
  'dashboard.filtro.tela': "questo schermo",
  'dashboard.filtro.vazio': "Nessuno schermo corrisponde a questo filtro",
  'dashboard.filtro.vazio_desc': "Il parco può essere cambiato da quando questo link è stato creato.",
  'dashboard.no_displays': 'Nessun schermo presente',
  'dashboard.no_displays_desc': 'Installa l\'app Loop Player sulla tua TV e associala usando il pulsante sopra.',
  ...
  'content.schedule_hint': "Scegli un tipo per aggiungere una regola. Le regole dello stesso tipo sono alternative; quelle di tipi diversi devono valere tutte. Vale per tutte le liste che contengono questo file. Senza regole viene sempre riprodotto.",
  ...
  'device.zone.title': "Quale playlist va in ogni zona",
  ...
  'device.replace.done': "\"{name}\" ora funziona sul nuovo dispositivo",
  ...
  'settings.setup_step_1': 'Installa l\'APK di Loop Player sulla tua TV tramite sideloading',
  ...
  'settings.import.invalid_file': 'File non valido. Deve essere un file JSON o ZIP esportato da Loop Player.',
  ...
  'playlist.duplicate_playlist': "Duplica playlist",
  'playlist.toast.duplicated': "Copiata come \"{name}\" — è una bozza, pubblicala per inviarla agli schermi",
  'playlist.bulk_duplicate_one': "Duplica 1",
  'playlist.bulk_duplicate_other': "Duplica {n}",
  'playlist.bulk_duplicated_one': "1 playlist duplicata — la copia è una bozza",
  'playlist.bulk_duplicated_other': "{n} playlist duplicate — le copie sono bozze",
  ...
  'playlist.sub_order_sequence': "In sequenza",
  'playlist.sub_order_random': "Casuale",
  'playlist.sub_order_hint': "In sequenza riproduce la lista dall’alto in basso. Casuale la mescola, senza ripetere un elemento prima che siano passati tutti.",
  'playlist.toast.sub_order_saved': "Ordine cambiato — pubblica la lista per inviarla agli schermi",
  ...
  'onboarding.step.welcome.title': 'Benvenuto su Loop Player!',
