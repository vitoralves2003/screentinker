...
| 3 | Gestão (web) | `https://beta.loopplayer.com.br/gestao/entrar` | 200 e o texto `<title>Loop Player</title>` (a porta desenha no navegador; o servidor manda a casca com o título) | o Next e a porta do produto |
